            ...
            <li>
              {isLoading ? (
                ...
                <div
                  ...
                  } items-center p-2 text-base font-normal text-gray-900 hover:border-blue-500 hover:border-b-2`}
                >
                  <div className="flex justify-start">
                    <IoAirplaneOutline className="text-blue-500" size={24} />
                  </div>
                  <span className="flex-1 ml-3 whitespace-nowrap text-[15px] text-black">
                    Pesawat
                  </span>
                </div>
              )}
          ...
          {whitelistDLU === 1 && (
            <li>
              {isLoading ? (
                ...
                >
                  <IoBoatSharp className="text-green-500" size={20} />
                  <span className="flex-1 ml-3 whitespace-nowrap text-[15px] text-black">
                    Dlu Kapal
                  </span>
                </div>
