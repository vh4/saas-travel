                ...
                {(isLoading || type === 'auth' || type === 'pesawat') && (
                        <li>
                            {isLoading ? (
                                ...
                                <div onClick={() => setNameMenu('pesawat')} className={`mt-4 block center cursor-pointer items-center text-sm font-bold text-gray-900 ${ nameMenu === 'pesawat' ? 'border-b-2 border-blue-500' : ''}`}>
