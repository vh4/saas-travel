      ...
      try {
        ...
        if (responseMerchant.data.rc === "00") {
          ...
          setDataTransport({
            kereta:
              hardcode_pay === "2"
                ? [harcodeDataPayKai, ...data.kereta?.data]
                : data.kereta?.data || [],
            pesawat:
              hardcode_pay === "2"
                ? [harcodeDataPayPesawat, ...data.pesawat?.data]
                : data.pesawat?.data || [],
            pelni:
              hardcode_pay === "2"
                ? [harcodeDataPayPelni, ...data.pelni?.data]
                : data.pelni?.data || [],
          });
                      ...
                      <div className="flex justify-center items-center mt-12">
                        <div className="text-center">
                          ...
                          <div className="mt-2 text-center text-black text-xs">
                            Maaf, History Data Transaksi tidak ditemukan.
                            Lakukan Booking terlebih dahulu.
                          </div>
                        </div>
                      </div>
                    </>
