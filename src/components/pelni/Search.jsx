...
export default function Search() {
  ...
  const handlerSearch = async () => {
    ...
    try {
      ...
      if (response.data.rc === "00") {
        ...
        setFilterNamaKapal(
          dataParsingLength.map((item) => `${item.SHIP_NAME}:true`)
        );
  ...
  const handleFilterKapalChange = (nama_ship, index) => {
    ...
    const currentStatus =
      updatedFilterNamaKapalVariable[index].split(":")[1] === "true";
        ...
        <>
          <>
            ...
            <div className="mt-4 xl:mt-8">
              <div className="block xl:flex flex-col xl:flex-row xl:justify-between items-center xl:space-x-4">
                <div className="hidden xl:flex items-center space-x-3 text-center xl:text-left">
                  <small className="text-xs font-normal  text-black">
                    {originName}
                  </small>
                  <div className="hidden xl:flex bg-blue-500 p-1 rounded-full">
                    <IoArrowForwardOutline
                      className=" text-xs text-white"
                      size={16}
                    />
                  </div>
                  <small className="hidden xl:flex text-xs font-normal  text-black">
                    {destinationName}
                  </small>
                  <div className="hidden xl:block font-normal text-black">
                    |
                  </div>
                  <div className="hidden xl:flex space-x-4 text-xs  text-black">
              ...
              {/* desktop filter */}
              <div className="hidden xl:flex justify-between mt-4 xl:mt-8">
                <div className="relative flex items-center space-x-2 text-black text-xs font-normal ">
                  ...
                  >
                    <div className="pl-2 flex  space-x-2 items-center cursor-pointer">
                  ...
                  <div
                    ...
                    className="pl-2 flex xl:hidden space-x-2 items-center cursor-pointer"
                  >
                    <SlArrowDown className="text-black " size={16} />
                    <div className="text-xs text-black">Ubah Pencarian</div>
                  </div>
                </div>
                <div className="mt-0 block xl:flex space-x-0 xl:space-x-4 mr-0 xl:mr-0 justify-start xl:justify-end">
                  <Link
                    to="/"
                    className="hidden xl:flex space-x-2 items-center"
                  >
                  ...
                  <button
                    onClick={() => setUbahPencarian((prev) => !prev)}
                    className="hidden xl:block border p-2 px-4 xl:px-4  bg-blue-500 text-white rounded-md text-xs "
                  >
                    Ubah Pencarian
                  </button>
                </div>
            ...
            <div>
              {isLoading ? (
                ...
                <div className="row w-full p-2">
                                ...
                                <>
                                  ...
                                  >
                                    ...
                                    <div className="hidden xl:block w-full text-black ">
                                      <div className="px-4 xl:px-0 2xl:px-4 mt-4 grid grid-cols-1 xl:grid-cols-8 gap-0 xl:gap-4">
                                        <div className="col-span-1 xl:col-span-2">
                                          ...
                                          <div>
                                            <small>
                                              Class {e.fares[i].CLASS} Subclass
                                              ({e.fares[i].SUBCLASS})
                                            </small>
                                          </div>
                                          <div>
                                            <small>Ship No. {e.SHIP_NO}</small>
                                          </div>
                                        </div>
                                        <div className="flex">
                                          <div className="">
                                        ...
                                        <div className="">
                                          <h1 className="mt-4 xl:mt-0 text-sm font-normal  text-blue-500">
                                            Adult Rp.
                                            {toRupiah(
                                              e.fares[i].FARE_DETAIL.A.TOTAL
                                            )}
                                          </h1>
                                          <small className="text-red-500">
                                            Infant Rp.
                                            {toRupiah(
                                              e.fares[i].FARE_DETAIL.I.TOTAL
                                            )}
                                          </small>
                                        </div>
                                        <div>
                                    ...
                                    <div>
                                      ...
                                      <div
                                        ...
                                        className={`cursor-pointer block xl:hidden min-w-max text-black`}
                                      >
                  ...
                  {/* untuk sorting yang availbility nya habis. */}
                          ...
                          {e.fares.map((z, i) => (
                            <>
                              ...
                              e.fares[i]["F_available"] == "0" ? (
                                <>
                                  <div
                                    className={`mt-6 w-full p-2 py-4 xl:px-6 2xl:px-10 xl:py-8 ${
                                      e.fares[i]["M_available"] == "0" &&
                                      e.fares[i]["F_available"] == "0"
                                        ? "bg-white xl:bg-gray-200"
                                        : "bg-white"
                                  ...
                                  >
                                    ...
                                    <div>
                                      ...
                                      {/*  cari mobile*/}
                                      <div
                                        className={`cursor-pointer block xl:hidden min-w-max text-gray-400`}
                                      >
                                        <div className="w-full bg-white">
                                          <div className="flex justify-between">
                                            <div>
                ...
                <div className="row mt-24 mb-24 w-full p-2">
                  ...
                  <div className="flex justify-center w-full text-black">
                    <div className="text-black text-center">
                      <div>
                        <div className="text-sm xl:text-md font-normal">
