...
export default function BookingPelni(){
    ...
    const dataDetailPelni = JSON.parse(localStorage.getItem("v_ship"));
    ...
    const token = JSON.parse(localStorage.getItem(process.env.REACT_APP_SECTRET_LOGIN_API));
        ...
        if(dataDetailPelni == null || dataDetailPelni == undefined){
            err  = true;
        }

		var date_Keberangkatan = new Date(dataDetailPelni ? dataDetailPelni.departureDate : new Date());
		var date_tujuan = new Date(dataDetailPelni ? dataDetailPelni.arrivalDate : new Date());
		var duration = dataDetailPelni ? dataDetailPelni.duration : new Date();
    ...
    const TotalWanita = dataDetailPelni ?  parseInt(dataDetailPelni.female) : 0;
    const TotalPria = dataDetailPelni ? parseInt(dataDetailPelni.male) : 0;

    const WanitaArr = Array();
    const PriaArr = Array();


    for(var i = 0; i < TotalWanita; i++){
        WanitaArr.push({
            name: '',
        ...
        const [wanita, setWanita] = useState([WanitaArr]);
        const [pria, setPria] = useState([PriaArr]);

        const handleUsiasubCatagoryChange = (e, i, category, type = 'pria') => e => { 
			...
			if(category == 'birthdate'){
                let tanggalParse = new Date(e).toLocaleDateString('id-ID', { day: '2-digit', month: '2-digit', year: 'numeric' }).split('/').reverse().join('-');
        ...
        const handlerBookingSubmit = async () => {
            ...
            if(totalAdult == 0){
                setIsLoading(false);
                failedNotification('Bayi tidak boleh sendiri (maksimal 1 dewasa membawa 1 bayi).')
            ...
            const response = await axios.post(`${process.env.REACT_APP_HOST_API}/travel/pelni/book`, params)
            ...
            setTimeout(() => {
              ...
              if(response.data.rc !== "00"){
                  failedNotification(response.data.rd);
                    ...
                    const infobooking = await axios.post(`${process.env.REACT_APP_HOST_API}/travel/pelni/book_info`, {
                    ...
                    if(infobooking.data.rc !== "00"){
                        ...
                        localStorage.setItem('v_pelnibook', JSON.stringify(data));
                        localStorage.setItem('v_infopelnibook', JSON.stringify(infobooking.data.data));
                        localStorage.setItem('v_passengers', JSON.stringify({
                            ...params,
        ...
        <div className='xl:mt-0'>
            ...
            <div className='mt-8 block xl:hidden w-full rounded-md border border-gray-200 shadow-sm'>
                    ...
                    <div className='p-4 pl-8  text-gray-700'>
                        <div className='text-xs font-bold'>{dataDetailPelni.shipName}</div>
                        <small>dataDetailPelni.class Subclass ({dataDetailPelni.subClass})</small>
                    </div>
                    ...
                    <ol class="relative border-l border-gray-500 ">                  
                            <li class="mb-10 ml-4">
                                ...
                                <div className='flex space-x-12'>
                                    <time class="mb-1 text-sm font-normal leading-none text-gray-400 ">{dataDetailPelni && dataDetailPelni.departureTime}</time>
                                    <div className='-mt-2'>
                                        <h3 class="text-left text-xs text-slate-600 ">{dataDetailPelni && dataDetailPelni.pelabuhan_asal}</h3>
                                    </div>
                                </div>
                            </li>
                            <li class="ml-4">
                                ...
                                <div className='flex space-x-12'>
                                    <time class="mb-1 text-sm leading-none text-gray-400 ">{dataDetailPelni && dataDetailPelni.arrivalTime}</time>
                                    <div className='-mt-2'>
                                        <h3 class="text-left text-xs  text-slate-600 ">{dataDetailPelni && dataDetailPelni.pelabuhan_tujuan}</h3>
                                    </div>
                                </div>
                            </li>
                        </ol>
            ...
            <div className='w-full mb-24 block xl:flex xl:space-x-10'>
                ...
                <Form onFinish={handleSubmit(handlerBookingSubmit)} className='block w-full  mt-8 mb-4 xl:mt-12'>
                        ...
                        <>
                            <div>
                                <div className='Booking  mt-8 mb-4 xl:mt-12 ml-2 xl:ml-0'>
                                    <h1 className='text-sm font-bold text-slate-500'>PRIA PASSENGER</h1>
                                                        ...
                                                        <div className='text-gray-500 text-sm'>Titel Anda</div>
                                                            <div className='hidden xl:block'>
                                                                ...
                                                                <Select
                                                                    ...
                                                                    value={e.usia}
                                                                    size='large'
                                                                    onChange={handleUsiasubCatagoryChange(e, i, 'usia', 'pria')} 
                                                                    />
                                                                </FormControl>  
                                                            </div>
                                                            ...
                                                            <div className='w-full grid grid-cols-2 gap-2'>                                    
                                                                <div className='w-full'>
                                                                    ...
                                                                    <Form.Item  name={`namadepanPria${i}`} rules={[{required:true, message:'Tolong diisi input nama depan'}, { min: 3, message: 'Nama depan harus min. 3 huruf.' }]}>
                                                                        <Input size='large' className='mt-2' value={e.nama_depan} onChange={handleUsiasubCatagoryChange(e, i, 'nama_depan', 'pria')}  type="text" placeholder='Nama Depan' id="default-input" />
                                                                    </Form.Item>
                                                                </div>
                                                                <div className='w-full'>
                                                                    <div className='text-gray-500 text-sm'>Nama Belakang</div>
                                                                    <Form.Item  name={`namabelakangPria${i}`} rules={[{required:true, message:'Tolong diisi input nama belakang'}, { min: 2, message: 'Nama belakang harus min. 2 huruf.' }]}>
                                                                        <Input size='large' className='mt-2'   value={e.nama_belakang} onChange={handleUsiasubCatagoryChange(e, i, 'nama_belakang', 'pria')}  type="text" placeholder='Nama Belakang' id="default-input"/>
                                                                    </Form.Item>
                                                                </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className='mb-8 mt-0 xl:mt-4'>
                                                <div className='block py-0 px-0 xl:px-8 xl:grid xl:grid-cols-2 gap-2 mt-0 xl:-mt-6'>
                                                    ...
                                                    <div className='w-full px-4 xl:px-0'>
                                                        ...
                                                        <Form.Item  name={`tanggalPria${i}`} rules={[{required:true, message:'Tolong diisi input tanggal lahir'}, ]}>
                                                            <DatePicker
                                                            size='large'
                                                            className='w-full'
                                                            value={dayjs(e.birthdate, 'YYYY/MM/DD')} format={'YYYY/MM/DD'}
                                                            onChange={handleUsiasubCatagoryChange(e, i, 'birthdate', 'pria')}
                                                    ...
                                                    <div className='w-full'>
                                                        <div className='px-4 xl:px-0 w-full block mt-4 xl:mt-0'>
                                                                ...
                                                                <Form.Item  name={`nikPria${i}`} rules={[{required:true, message:'Tolong diisi input ktp atau nik'}, { min: 16, message: 'Nik / No.ktp harus 16 huruf.' }, { max: 16, message: 'Nik / No.ktp harus 16 huruf.' }]}>
                                                                    <Input name={`nikPria${i}`} size='large' className='mt-2' value={e.identityNumber} onChange={handleUsiasubCatagoryChange(e, i, 'identityNumber', 'pria')} type="text" placeholder='No. Ktp / NIK'  id="default-input"/>
                                                                </Form.Item>
                    ...
                    {/* wanita loop */}
                    { wanita && wanita[0].map((e, i) => (
                        <>
                            <div>
                                <div className='Booking  mt-8 mb-4 xl:mt-12 ml-2 xl:ml-0'>
                                    <h1 className='text-sm font-bold text-slate-500'>WANITA PASSENGER</h1>
                                    <small className='text-gray-500'>Isi sesuai dengan data anda</small>
                                </div>
                                {/* Detailt */}            
                                <div className='flex space-x-12'>
                                    ...
                                    <div className='w-full mt-4 xl:mt-0 border border-gray-200 shadow-sm col-span-1 xl:col-span-1'>
                                                        ...
                                                        <div className='text-gray-500 text-sm'>Titel Anda</div>
                                                            <div className='hidden xl:block'>
                                                                ...
                                                                <Select
                                                                    ...
                                                                    value={e.usia}
                                                                    size='large'
                                                                    onChange={handleUsiasubCatagoryChange(e, i, 'usia', 'wanita')} 
                                                                    />
                                                                </FormControl>  
                                                            </div>
                                                            <div className='block xl:hidden'>
                                                            ...
                                                            <div className='w-full grid grid-cols-2 gap-2'>                                    
                                                                <div className='w-full'>
                                                                    <div className='text-gray-500 text-sm'>Nama Depan</div>
                                                                    <Form.Item  name={`namadepanWanita${i}`} rules={[{required:true, message:'Tolong diisi input nama depan'}, { min: 3, message: 'Nama depan harus min. 3 huruf.' }]}>
                                                                        <Input size='large' className='mt-2' value={e.nama_depan} onChange={handleUsiasubCatagoryChange(e, i, 'nama_depan', 'wanita')}  type="text" placeholder='Nama Depan' id="default-input" />
                                                                    </Form.Item>
                                                                </div>
                                                                <div className='w-full'>
                                                                    <div className='text-gray-500 text-sm'>Nama Belakang</div>
                                                                    <Form.Item  name={`namabelakangWanita${i}`} rules={[{required:true, message:'Tolong diisi input nama belakang'}, { min: 2, message: 'Nama belakang harus min. 2 huruf.' }]}>
                                                                        <Input size='large' className='mt-2' value={e.nama_belakang} onChange={handleUsiasubCatagoryChange(e, i, 'nama_belakang', 'wanita')}  type="text" placeholder='Nama Belakang' id="default-input"/>
                                                                    </Form.Item>
                                                                </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className='mb-8 mt-0 xl:mt-4'>
                                                <div className='block py-0 px-0 xl:px-8 xl:grid xl:grid-cols-2 gap-2 mt-0 xl:-mt-6'>
                                                    ...
                                                    <div className='w-full px-4 xl:px-0'>
                                                        <div className='xl:px-0 w-full text-gray-500 text-sm mb-2'>Tanggal Lahir</div>                                                        
                                                        <Form.Item  name={`tanggalWanita${i}`} rules={[{required:true, message:'Tolong diisi input tanggal lahir'}, ]}>
                                                            <DatePicker
                                                            size='large'
                                                            className='w-full'
                                                            value={dayjs(e.birthdate, 'YYYY/MM/DD')} format={'YYYY/MM/DD'}
                                                            onChange={handleUsiasubCatagoryChange(e, i, 'birthdate', 'wanita')}
                                                    ...
                                                    <div className='w-full'>
                                                        <div className='px-4 xl:px-0 w-full block mt-4 xl:mt-0'>
                                                                <div className='text-gray-500 text-sm'>No. Ktp</div>
                                                                <Form.Item  name={`nikWanita${i}`} rules={[{required:true, message:'Tolong diisi input ktp atau nik'}, { min: 16, message: 'Nik / No.ktp harus 16 huruf.' }, { max: 16, message: 'Nik / No.ktp harus 16 huruf.' }]}>
                                                                    <Input name={`nikWanita${i}`} size='large' className='mt-2' value={e.identityNumber} onChange={handleUsiasubCatagoryChange(e, i, 'identityNumber', 'wanita')} type="text" placeholder='No. Ktp / NIK'  id="default-input"/>
                                                                </Form.Item>
                                                                <small className='block -mt-4 text-gray-400'>Contoh: 16 digit nomor</small>
                                                                <div>
                                                            </div>
                ...
                <div className='w-1/2 xl:mt-16'>
                    <div className='hidden xl:block rounded-md border border-gray-200 shadow-sm'>
                            <div className='p-4 py-4 border-t-0 border-b border-r-0 border-l-4 border-l-blue-500 border-b-gray-100'>
                                <div className='text-gray-700 text-sm font-bold'>Keberangkatan Kapal</div>
                                <small className='text-xs text-gray-700'>{duration}</small>
                            </div>
                            <div className='px-4 xl:px-8 p-4 flex justify-between space-x-12 items-center'>
                                <div className='text-xs'>
                                    <div className='font-bold text-slate-600'>{dataDetailPelni && dataDetailPelni.pelabuhan_asal}</div>
                                    <small className='text-xs text-gray-700'>({tanggal_keberangkatan_pelni})</small>
                                </div>
                                <div className='rounded-full p-1 bg-blue-500 '>
                                    < TbArrowsLeftRight className='text-white' size={18} />
                                </div>
                                <div className='text-xs'>
                                    <div className=' font-bold text-slate-600'>{dataDetailPelni && dataDetailPelni.pelabuhan_tujuan}</div>
                                    <small className='text-xs text-gray-700'>({tanggal_tujuan_pelni})</small>
                                </div>
                            </div>

                            <div className='p-4 pl-8 text-gray-700'>
                                <div className=' text-xs font-bold'>{dataDetailPelni && dataDetailPelni.shipName}</div>
								<small>{dataDetailPelni.class} / Subclass ({dataDetailPelni.subClass})</small>
                            </div>
                            ...
                            <ol class="relative border-l-2 border-dotted border-gray-300 ">                  
                                    <li class="mb-10 ml-4 text-sm">
                                        ...
                                        <div className='flex space-x-12'>
                                            <time class="mb-1 text-xs font-bold leading-none text-gray-400 ">{dataDetailPelni && dataDetailPelni.departureTime}</time>
                                            <div className=''>
                                                <h3 class="text-left text-xs font-bold text-slate-600 ">{dataDetailPelni && dataDetailPelni.pelabuhan_asal}</h3>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="ml-4 text-sm mt-10">
                                        ...
                                        <div className='flex space-x-12'>
                                            <time class="mb-1 text-xs font-bold leading-none text-gray-400 ">{dataDetailPelni && dataDetailPelni.arrivalTime}</time>
                                            <div className=''>
                                                <h3 class="text-left text-xs font-bold text-slate-600 ">{dataDetailPelni && dataDetailPelni.pelabuhan_tujuan}</h3>
                                            </div>
                                        </div>
                                    </li>
                                </ol>
