...
export default function Tiket({data}){
    ...
    return(
        ...
        <div className='hidden xl:block bg-white border-b rounded-lg p-4 xl:p-8 lg:p-6 max-w-4xl mx-auto relative'>
            <div className='flex text-black justify-start jalur-payment-booking text-xs xl:text-sm space-x-2 xl:space-x-8 items-center'>
                <div className='flex space-x-2 items-center'>
                    ...
                    {/* <div className='block xl:hidden text-green-500'>Detail</div> */}
                </div>
                <div>
                ...
                <div className='flex space-x-2 items-center'>
                    ...
                    {/* <div className='block xl:hidden text-green-500'>Payment</div> */}
                </div>
                <div>
                    <MdHorizontalRule size={20} className='text-black hidden xl:flex' />
                </div>
        ...
        <div className="bg-white text-black border-b rounded-lg p-4 xl:p-8 lg:p-12 max-w-4xl mx-auto my-8">
