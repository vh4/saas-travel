...
import { FilterMobilePelniDrawer, SearchMobilePelniDrawer } from "./FilterMobilePelniDrawer";
  ...
  return (
    <div>
      ...
      <FilterMobilePelniDrawer
         ...
         <SearchMobilePelniDrawer openDrawer={openDrawer === "search"} toggleDrawer={() => setOpenDrawer(null)} />
    </div>
  );
}
