        ...
        if(limit === selectedCount){
            ...
            for(let i = 0; i < limit; i++){
                if(selectedCheckboxes[i] !== null && selectedCheckboxes[i] !== undefined){
                    const splittingSeat = selectedCheckboxes[i].split('-');
...
export default function Konfirmasi(){
    ...
    async function handlerPilihKursi(e) {
     ...
     const handlerPindahKursi = async (e) => {
        ...
        const changeStateFix = changeState;

        const wagonNumber = changeStateFix[0][0]["wagonNumber"];
        const className = changeStateFix[0][0]["class"];
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        (
                                    ...
                                    {/* sidebar seats Kai */} 
                                        <div className='text-start mt-8'>
                                            {changeState[0].map((e, i) =>(
                                                <>
                                                {e.type === 'adult' && (
                                                    <div className='border m-6 rounded-md mt-2 text-xs font-bold'>
                                        ...
                                        <div className="overflow-y-auto col-span-2 w-full h-[540px]">
                            ...
                            <div className="flex items-center justify-end p-6  border-solid border-slate-200 rounded-b">
                                ...
                                <button onClick={handlerPindahKursi} className="bg-blue-500 text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button"> PINDAH KURSI </button>
                              </div>
                            </form>
                        ...
                        (
                            <>
                                <div className="w-5/6  flex justify-center items-center my-auto py-auto">
