                                        ...
                                        {/* sidebar seats Kai */} 
                                            ...
                                            <div className="flex justify-center mb-8 mt-4">
                                                ...
                                                <div className="w-1/2 ">
                                                    ...
                                                    <select onChange={(e) => setClickSeats(e.target.value) } id="underline_select" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none  focus:outline-none focus:ring-0 focus:border-gray-200 peer">
            ...
            <Modal.Footer>
                ...
                {isLoadingPindahKursi === true ? (
                    <div className="flex space-x-2 items-center">
                        <svg aria-hidden="true" class="mr-2 w-4 h-4 text-gray-200 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ol class="relative border-l border-dashed border-gray-500">                  
                            <li class="mb-10 ml-4">
                                ...
                                <div className='flex space-x-12'>
                                    ...
                                    <div className='-mt-2'>
                                        <h3 class="text-left text-xs text-slate-600 font-bold ">{dataBookingTrain && dataDetailTrain[0].berangkat_nama_kota}</h3>
                                        <p class="text-left text-xs text-gray-500 ">({dataBookingTrain && dataDetailTrain[0].berangkat_id_station})</p>
                                    </div>
                                </div>
                            </li>
                            <li class="ml-4">
                                ...
                                <div className='flex space-x-12'>
                                    ...
                                    <div className='-mt-2'>
                                        <h3 class="text-left text-xs  text-slate-600 font-bold ">{dataBookingTrain && dataDetailTrain[0].tujuan_nama_kota}</h3>
                                        <p class="text-left text-xs text-gray-500 ">({dataBookingTrain && dataDetailTrain[0].tujuan_id_station})</p>
                                    </div>
                                </div>
                            </li>
                        </ol>
