...
const FilterMobileKeretaDrawer = ({ openDrawer, toggleDrawer, waktuFilter, handleWaktuFilterChange, valHargaRange, hargraRangeChange}) => {
  return (
    <SwipeableDrawer
      anchor="bottom"
...
const SortMobileKeretaDrawer = ({ openDrawer, toggleDrawer, HargaTerendahTinggi, setHargaTerendahTinggi }) => {
  return (
    <SwipeableDrawer
      anchor="bottom"
      PaperProps={{ sx: { borderTopLeftRadius: 30, borderTopRightRadius: 30 } }}
...
export { FilterMobileKeretaDrawer, SortMobileKeretaDrawer, SearchMobileKeretaDrawer };
